...
interface AvatarUpdateProps {
  ...
  userId: string;
  userName: string;
  setIsModalOpen: (state: boolean) => void;  // Add setIsModalOpen as a prop
}

const AvatarUpdate = ({ currentAvatar, userId, userName }: AvatarUpdateProps) => {
  ...
  useEffect(() => {
    console.log("Current avatar in AvatarUpdate:", currentAvatar);
  }, [currentAvatar]);
  return (
    <>
      <div 
