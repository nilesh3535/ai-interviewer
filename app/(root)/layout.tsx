    ...
    <>
      <div className="root-layout">
        ...
        <nav className="w-full flex items-center justify-between ">
          ...
          {/*  */}
          <div
            className="bg-[#171532] flex-none gap-4 flex items-center rounded-sm px-2 hidden md:flex"
            style={{ height: 50 }}
          >
            <a
          ...
          <div className="hidden lg:flex flex-col items-center rounded-2xl border border-gray-200 pl-10 p-3 bg-[#272727]">
            {user && (
          ...
          {/* Small & medium screens — only dropdown */}
