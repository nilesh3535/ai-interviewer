...
export default function ResumeCheckerContent() {
    ...
    try {
      ...
      if (webhookRes.ok) {
        ...
        setTimeout(() => {
          ...
          setStepsLoader(true);
          setN8nData(webhookData);
        }, 3000);
      }
    } catch (err) {
      console.error("Error parsing OCR:", err);
      toast.error("Error parsing or sending data. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  function normalizeBullets(bullets: any): string[] {
    ...
    // If it’s an object (e.g. {0:"line1",1:"line2"})
    if (typeof bullets === "object") return Object.values(bullets).map(String);
                          ...
                          <div className="px-[60pt] py-8 font-normal text-[#171717]">
                            ...
                            {!hideEducation && (
                              <h2
                                ...
                                style={{ color: themeColor }}
                              >
                                {aieducation.length ? educationTitle : ""}
                              </h2>
                            )}
                            {!hideEducation &&
                            ...
                            {!hideEducation && aieducation.length ? (
                              <div className="w-full h-px bg-[#2e2e2e] my-2"></div>
                            ) : (
                              <></>
                            )}
                            ...
                            {!hideProjects && (
                              <h2
                                ...
                                style={{ color: themeColor }}
                              >
                                {aiprojects.length ? projectTitle : ""}
                              </h2>
                            )}
                            {!hideProjects &&
                            ...
                            <div className="px-[60pt] py-8 font-normal text-[#171717]">
                              ...
                              {!hideEducation && (
                                <h2
                                  ...
                                  style={{ color: themeColor }}
                                >
                                  {education.length ? educationTitle : ""}
                                </h2>
                              )}
                              {!hideEducation &&
                                education.map((edu, i) => (
                              ...
                              {!hideEducation && education.length ? (
                                <div className="w-full h-px bg-[#2e2e2e] my-2"></div>
                              ) : (
                                <></>
                              )}
